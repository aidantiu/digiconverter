            ...
            <div className="bg-white rounded-lg shadow-xl max-w-md w-full mx-4 animate-fadeIn">
                ...
                <div className="p-6">
                    ...
                    <div className="flex justify-end space-x-3">
                        ...
                        <button
                            onClick={onClose}
                            className="px-4 py-2 text-sm font-medium text-white bg-gray-600 border border-transparent rounded-md hover:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 transition-colors"
                        >
                            Choose Another File
                        </button>
                    </div>
